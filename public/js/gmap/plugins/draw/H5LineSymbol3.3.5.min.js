...
var y="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)},z="undefined"!=typeof window&&window===this?this:"undefined"!=typeof global&&null!=global?global:this;function A(a,b){if(b){var c=z;a=a.split(".");for(var d=0;d<a.length-1;d++){var e=a[d];e in c||(c[e]={});c=c[e]}a=a[a.length-1];d=c[a];b=b(d);b!=d&&null!=b&&y(c,a,{configurable:!0,writable:!0,value:b})}}
A("Array.prototype.fill",function(a){return a?a:function(a,c,d){var e=this.length||0;0>c&&(c=Math.max(0,e+c));if(null==d||d>e)d=e;d=Number(d);0>d&&(d=Math.max(0,e+d));for(c=Number(c||0);c<d;c++)this[c]=a;return this}});
(function(){function a(d,a){var c=d.x-a.x;d=d.y-a.y;a=Math.sqrt(c*c+d*d);return 0<d?Math.acos(c/a):2*Math.PI-Math.acos(c/a)}function b(d,a){var c=d.x-a.x;d=d.y-a.y;a=Math.sqrt(c*c+d*d);c=0<d?Math.acos(c/a)+Math.PI/2:2*Math.PI-Math.acos(c/a)+Math.PI/2;c>2*Math.PI&&(c-=2*Math.PI);return c%(2*Math.PI)}var c={};window.f=c;c.a=function(d,a){this.x=d;this.y=a};c.a.prototype={sub:function(d){return new c.a(this.x-d.x,this.y-d.y)},add:function(d){return new c.a(this.x+d.x,this.y+d.y)},length:function(){return Math.sqrt(this.x*
this.x+this.y*this.y)},normalize:function(d){var a=this.length();this.x=this.x*d/a;this.y=this.y*d/a},toString:function(){return"["+this.x+","+this.y+"]"},va:function(d){return 1E-6>Math.abs(d.x-this.x)&&1E-6>Math.abs(d.y-this.y)?!0:!1},clone:function(){return new c.a(this.x,this.y)},set:function(d){this.x=d.x;this.y=d.y}};c.a.f=function(d,a,b){return new c.a(d.x*b+a.x*(1-b),d.y*b+a.y*(1-b))};c.a.g=function(d,a){return Math.sqrt((a.x-d.x)*(a.x-d.x)+(a.y-d.y)*(a.y-d.y))};c.ba=function(a,c,b,k,g){this.P=
a;this.R=c;this.h=b;this.i=k;this.end=g};c.K=function(){this.l=-1;this.B=10;this.S=2;this.ua=this.ta=this.F=.5};c.A=function(a,e){this.C=new c.a(a,e);this.j=new c.a(a,e);this.s=new c.a(a,e)};c.O=function(a,c,b,k,g,h){this.pa=a;this.ra=c;this.sa=b;this.d=k;this.e=g;this.wa=h};c.O.prototype={xa:function(){this.pa=1;this.ra=this.e=this.sa=0;this.d=1;this.wa=0},rotate:function(a){var d=Math.cos(a);a=Math.sin(a);return new c.O(d,a,-a,d,0,0)},ya:function(a){return new c.a(this.pa*a.x+this.sa*a.y+this.e,
this.ra*a.x+this.d*a.y+this.wa)}};c.c=function(){};c.c.o=function(a,e,b,k){e=(e.y-a.y)/(e.x-a.x);k=(k.y-b.y)/(k.x-b.x);if(e==k)return null;if(isFinite(e)){if(isFinite(k)){var d=a.y-e*a.x;b=b.y-k*b.x;a=(d-b)/(k-e)}else d=a.y-e*a.x,a=b.x;b=e*a+d}else a=a.x,b=b.y-k*b.x,b=k*a+b;return new c.a(a,b)};c.c.g=function(a,c,b){b=b.sub(c);a=a.sub(c);return 0<b.x*a.y-b.y*a.x?!0:!1};c.c.$=function(a,e,b,k,g,h){h=Math.sqrt(Math.max(Math.max(c.a.g(e,b),c.a.g(e,k)),c.a.g(b,g)))*(h||1);30>h&&(h=30);for(var d,f,p=0;1>=
p;p+=1/h)d=Math.pow(p,3)*(b.x+3*(k.x-g.x)-e.x)+3*Math.pow(p,2)*(e.x-2*k.x+g.x)+3*p*(k.x-e.x)+e.x,f=Math.pow(p,3)*(b.y+3*(k.y-g.y)-e.y)+3*Math.pow(p,2)*(e.y-2*k.y+g.y)+3*p*(k.y-e.y)+e.y,a.push(new c.a(d,f))};c.c.u=function(a,e,b,k,g){for(var d,f=Math.sqrt(Math.max(Math.max(c.a.g(e,b),c.a.g(e,k)),c.a.g(b,k)))*(g||1),m=0;1>=m;m+=1/f)g=(1-m)*(1-m)*e.x+2*m*(1-m)*k.x+m*m*b.x,d=(1-m)*(1-m)*e.y+2*m*(1-m)*k.y+m*m*b.y,a.push(new c.a(g,d));a.push(new c.a(b.x,b.y))};c.c.Va=function(a,e,b){var d=b.sub(e);d=a.add(new c.a(-d.y,
d.x));e=c.a.f(e,b,.5).sub(c.c.o(e,b,a,d));return a.add(e).add(e)};c.c.D=function(a,e,b){var d=c.a.g(a,e),f=c.a.g(e,b);a=b.sub(a);a.normalize(1);b=new c.A(e.x,e.y);b.s.x=e.x-a.x*d*.3;b.s.y=e.y-a.y*d*.3;b.j.x=e.x+a.x*f*.3;b.j.y=e.y+a.y*f*.3;return b};c.c.J=function(a){for(var d=0,b=a.length,k=0;k<b-1;k++)d+=c.a.g(a[k],a[k+1]);return d};c.c.Ua=function(a,e){var d=a.length;if(0>e)return a[0];if(1<e)return a[d-1];e*=c.c.J(a);for(var b=0,g,h=0;h<d-1;h++){var l=c.a.g(a[h],a[h+1]);b+=l;if(b>=e){g=c.a.f(a[h],
a[h+1],(b-e)/l);break}}return g};c.c.v=function(a,e,b,k,g){var d=d||"JointStyle.MITER",f=f||Number.NaN,m=a.length;if(!(2>m))for(var p=c.c.J(a),n=0,q,r=0;r<m;r++)0==r?(q=c.c.Z(a[0],a[1],k),e.push(q.pop()),b.push(q.pop())):r==a.length-1?(q=c.c.Z(a[a.length-1],a[a.length-2],g),b.push(q.pop()),e.push(q.pop())):(n+=c.a.g(a[r],a[r-1]),q=c.c.Ba(a[r-1],a[r],a[r+1],k-n/p*(k-g),d,f),e.push(q.pop()),b.push(q.pop()))};c.c.Ba=function(a,e,b,k,g,h){var d=a.sub(e),f=b.sub(e);d.normalize(1);f.normalize(1);f=d.add(f);
f.normalize(1);if(.001>Math.abs(f.x)&&.001>Math.abs(f.y))return c.c.Z(e,b,k);"JointStyle.MITER"==g?(b=d.x*f.x+d.y*f.y,k/=Math.sqrt(1-b*b),!isNaN(h)&&k>h?f.normalize(h):f.normalize(k)):"JointStyle.ROUND"==g&&f.normalize(k);h=e.add(f);k=[];c.c.g(h,a,e)?(k.push(h),k.push(e.sub(f))):(k.push(e.sub(f)),k.push(h));return k};c.c.Z=function(a,e,b){e=e.sub(a);e=new c.a(e.y,-e.x);e.normalize(b);b=a.add(e);a=a.sub(e);e=[];e.push(a);e.push(b);return e};c.c.w=function(a,c){var d=[];if(2>a.length)return d;if(2==
a.length)return d.push(a[0]),d.push(a[1]),d;a=this.Fa(a,c);for(c=0;c<a.length-1;c++){var e=a[c],b=a[c+1];this.$(d,e.C,b.C,e.j,b.s,1)}return d};c.c.Fa=function(a,e){var d=[],b=a.length;if(e){for(e=0;e<b;e++)0==e?d.push(c.c.D(a[b-1],a[e],a[e+1])):e==b-1?d.push(c.c.D(a[e-1],a[e],a[0])):d.push(c.c.D(a[e-1],a[e],a[e+1]));d.push(c.c.D(a[b-1],a[0],a[1]))}else for(e=0;e<b;e++)0==e||e==b-1?d.push(new c.A(a[e].x,a[e].y)):d.push(c.c.D(a[e-1],a[e],a[e+1]));return d};c.c.T=function(a,e,b){if(0>(a.x-e.x)*(b.x-
e.x)+(a.y-e.y)*(b.y-e.y))var d=c.a.g(a,e);else if(0>(a.x-b.x)*(e.x-b.x)+(a.y-b.y)*(e.y-b.y))d=c.a.g(a,b);else{var f=a.sub(e),h=a.sub(b);f=Math.abs(f.x*h.y-f.y*h.x);b=c.a.g(e,b);0==b?d=c.a.g(a,e):d=f/b}return d};c.c.Sa=function(a){for(var d=[],b=a.length,k=0;k<b-1;k++){var g=a[k],h=a[k+1];c.c.$(d,g.C,h.C,g.s,h.j,3)}c.c.$(d,a[b-1].C,a[0].C,a[b-1].s,a[0].j,3);return d};c.b=function(){};c.b.w=function(a,e){a=c.c.w(a,e);e=[];for(var d=0;d<a.length;d++){var b=a[d];e.push([b.x,b.y])}return e};c.b.ma=function(a,
e,b){a=c.b.za(a,e,b);a=c.b.Ca(a[2],a[0],a[1]);a=c.c.Sa(a);e=[];for(b=0;b<a.length;b++){var d=a[b];e.push([d.x,d.y])}return e};c.b.za=function(a,e,b){var d=c.a.g(a,e),f=c.a.g(a,b),h=Math.max(d,c.a.g(e,b),f);return h==d?c.b.U(b,a,e):h==f?c.b.U(e,a,b):c.b.U(a,e,b)};c.b.U=function(a,e,b){var d=b.sub(e);d=new c.a(d.y,-d.x);var f=c.c.T(a,e,b);d.normalize(f);f=c.a.f(e,b,.5);var h=[];c.c.g(a,e,b)?(h.push(b),h.push(e),h.push(f.sub(d))):(h.push(e),h.push(b),h.push(f.add(d)));h.push(a);return h};c.b.Ca=function(a,
e,b){var d=[],f=c.a.g(e,b),h=c.a.f(e,b,.5),l=b.sub(e),m=new c.a(l.y,-l.x),p=c.c.T(a,e,b);m.normalize(f/4);var n=new c.O;n.xa();n=n.rotate(-Math.PI/8);var q=n.ya(m);n=new c.A(e.x,e.y);n.j=new c.a(e.sub(q).x,e.sub(q).y);n.s=new c.a(e.add(q).x,e.add(q).y);d.push(n);l.normalize(f/4);n=new c.A(a.x,a.y);n.j=new c.a(a.sub(l).x,a.sub(l).y);n.s=new c.a(a.add(l).x,a.add(l).y);d.push(n);m.normalize(f/4);n=new c.O;n.xa();n=n.rotate(Math.PI/8);q=n.ya(m);n=new c.A(b.x,b.y);n.j=new c.a(b.add(q).x,b.add(q).y);n.s=
new c.a(b.sub(q).x,b.sub(q).y);d.push(n);m.normalize(Math.sqrt(p));a=h.sub(m);l.normalize(f/4);n=new c.A(a.x,a.y);n.j=new c.a(a.add(l).x,a.add(l).y);n.s=new c.a(a.sub(l).x,a.sub(l).y);d.push(n);return d};c.b.W=function(a,e,b,k,g){a=e.sub(a);b*=a.length();b>k&&0<k?a.normalize(k):a.normalize(b);k=e.sub(a);return c.b.ea(k,e,g)};c.b.M=function(a,e,b){var d=e.sub(a);b=b?new c.a(d.y,-d.x):new c.a(-d.y,d.x);a=c.a.f(a,e,.5);d.length();b.x/=8;b.y/=8;return a.add(b)};c.b.V=function(a,e,b,k,g){if(!e.va(b)){g=
g||.5;var d=b.sub(e),f=-1!=k.l?k.l/2:d.length()/2;k.S=f/2;d=new c.a(d.y,-d.x);d.normalize(k.S*g);var m=e.add(d),p=e.sub(d),n=b.add(d),q=b.sub(d);d.normalize(f);g=e.add(d);var r=e.sub(d),v=c.a.f(b,e,k.F);m=c.c.o(m,n,v,g);p=c.c.o(p,q,v,r);e=c.a.f(b,e,k.ta);d=d.clone();d.normalize(f*k.ua);e.add(d);e.sub(d);a.push(m);a.push(g);a.push(b);a.push(r);a.push(p)}};c.b.X=function(a,e,b,k,g){e=b.sub(e);k*=e.length();e.normalize(k);k=b.sub(e);c.b.V(a,k,b,g,.5)};c.b.ea=function(a,e,b){if(a.va(e))return new c.ba(a,
a,a,a,a);var d=e.sub(a),f=-1!=b.l?b.l/2:d.length()/2;b.S=f/2;var h=new c.a(d.y,-d.x);h.normalize(b.S/2);d=a.add(h);var l=a.sub(h),m=e.add(h),p=e.sub(h);h.normalize(f);var n=a.add(h),q=a.sub(h),r=c.a.f(e,a,b.F);m=c.c.o(d,m,r,n);p=c.c.o(l,p,r,q);a=c.a.f(e,a,b.ta);h=h.clone();h.normalize(f*b.ua);a.add(h);a.sub(h);return new c.ba(d,l,m,p,e)};c.b.ja=function(a,b,f,k,g){var d=[],e=c.b.W(a,f,.3,80,g),m=c.b.W(b,k,.3,80,g),p=[],n=[];c.b.X(p,a,f,.3,g);c.b.X(n,b,k,.3,g);var q=c.c.g(f,a,b),r=c.c.g(k,a,b);k=c.c.g(e.h,
a,b);f=c.c.g(e.i,a,b);g=c.c.g(m.h,a,b);var v=c.c.g(m.i,a,b);if(0==q){var w=e.i,x=e.R,u=c.b.M(a,e.h,!0);c.c.u(d,a,e.h,u,3);d=d.concat(p)}else{w=e.h;x=e.P;u=c.b.M(a,e.i,!1);var B=[];c.c.u(B,a,e.i,u,3);d=d.concat(B);d=d.concat(p.reverse())}u=a.sub(b);1==r?(e=m.i,p=m.R,a=c.b.oa(a,b,w,e,q==r),q=a.add(u),c.b.aa(d,w,x,a,q,e,p,k==f,g==v),d=d.concat(n.reverse()),u=c.b.M(m.h,b,!1),c.c.u(d,m.h,b,u,3)):(e=m.h,p=m.P,a=c.b.oa(a,b,w,e,q==r),q=a.add(u),c.b.aa(d,w,x,a,q,e,p,k==f,g==v),d=d.concat(n),u=c.b.M(m.i,b,
!0),c.c.u(d,m.i,b,u,3));b=[];for(m=0;m<d.length;m++)n=d[m],b.push([n.x,n.y]);return b};c.b.aa=function(a,b,f,k,g,h,l,m,p){f=m?c.c.o(b,f,k,g):f;g=p?c.c.o(h,l,k,g):l;f&&c.c.u(a,b,k,f,1);g&&c.c.u(a,k,h,g,1)};c.b.oa=function(a,b,f,k,g){var d=c.a.f(a,b,.5),e=c.a.f(f,k,.5),m=a.sub(b),p=f.add(m);m=k.add(m);p=c.c.o(p,f,d,e);m=c.c.o(m,k,d,e);var n=c.a.g(d,p),q=c.a.g(d,m);c.c.g(f,a,b);c.c.g(k,a,b);if(g)return n<q?c.a.f(d,p,.7):c.a.f(d,m,.7);a=c.a.f(d,e,.9);return Math.min(n,q)>c.a.g(d,a)?a:n<q?c.a.f(p,d,.3):
c.a.f(m,d,.3)};c.b.L=function(a,b,f,k,g){var d=[],e=b.sub(a);e=new c.a(e.y,-e.x);e.normalize(c.a.g(a,b)*k);k=a.add(e);e=a.sub(e);d.push(k);c.b.V(d,c.a.f(a,b,.3),b,f,g);d.push(e);a=[];for(b=0;b<d.length;b++)f=d[b],a.push([f.x,f.y]);return a};c.b.N=function(a,b,f,k,g){g|=0;var d=[],e=c.a.f(a,b,.5);if(c.c.g(a,e,f))var m=b,p=a;else m=a,p=b;var n=c.a.f(e,f,.3);e=c.b.ea(n,f,k);var q=[];c.b.V(q,n,f,k);n=e.P.add(e.P.sub(e.h));k=e.R.add(e.R.sub(e.i));c.c.u(d,m,e.h,n);d=d.concat(q);m=[];c.c.u(m,e.i,p,k);d=
d.concat(m);1==g&&d.push(c.a.f(c.a.f(a,b,.5),f,.8));a=[];for(b=0;b<d.length;b++)f=d[b],a.push([f.x,f.y]);return a};c.b.ha=function(a,b){var d=.07,e=a.length,g=a[e-1],h=c.c.D(a[e-3],a[e-2],g),l=c.b.W(h.j,g,.5,200,b);e=[];c.b.X(e,h.j,g,.5,b);g=[];b=[];c.c.v(a,g,b,c.c.J(a)*d,c.a.g(l.h,l.i)/2);g[g.length-1]=l.h;b[b.length-1]=l.i;a=c.c.w(g);d=c.c.w(b);e=a.concat(e);e=e.concat(d.reverse());a=[];for(d=0;d<e.length;d++)l=e[d],a.push([l.x,l.y]);return a};c.b.Ta=function(a,b,f,k){var d=null,e=new c.K;if(2001==
a){if(4>b.length)return;d=c.b.ja(b[0],b[1],b[2],b[3],e)}else 2003==a?d=c.b.L(b[0],b[1],e,.125,.5):2004==a?(e.l=.8*c.a.g(b[0],b[1]),e.F=0,d=c.b.L(b[0],b[1],e,.35,.8)):2005==a?d=c.b.N(b[0],b[1],b[2],e):2006==a?d=c.b.N(b[0],b[1],b[2],e):2007==a?d=c.b.ha(b,e):2008==a?d=c.b.w(b,!0):2011==a&&(d=c.b.ma(b[0],b[1],b[2]));if(null!=d){k.beginPath();k.moveTo(d[0].x,d[0].y);for(a=1;a<d.length;a++)k.lineTo(d[a].x,d[a].y);k.lineTo(d[0].x,d[0].y);k.closePath();k.fillStyle=f.fillColor;k.fill()}return d};c.b.m=function(a,
e,f){var d=[];if(isNaN(f.x)||isNaN(f.y)||1>c.c.T(f,a,e))return[a,e];var g=(a.x*a.x-e.x*e.x+a.y*a.y-e.y*e.y)/2,h=(e.x*e.x-f.x*f.x+e.y*e.y-f.y*f.y)/2,l=a.x-e.x,m=e.x-f.x,p=a.y-e.y,n=e.y-f.y;g={x:(g*n-h*p)/(l*n-m*p),y:(g*m-h*l)/(p*m-n*l)};h=c.a.g(a,g);a=b(a,g)-Math.PI/2;l=b(e,g)-Math.PI/2;m=b(f,g)-Math.PI/2;e=Math.min(a,l);f=Math.max(a,l);if(m<e||m>f)a=e,e=f,f=a+2*Math.PI;for(;e<=f;e+=.1)a=g.x+h*Math.cos(e),l=g.y+h*Math.sin(e),d.push(new c.a(a,l));a=g.x+h*Math.cos(f);l=g.y+h*Math.sin(f);d.push(new c.a(a,
l));return d};c.b.da=function(a,b,f,k){for(var d=[];f<k;f+=.1){var e=a.x+b*Math.cos(f),l=a.y+b*Math.sin(f);d.push(new c.a(e,l))}e=a.x+b*Math.cos(k);l=a.y+b*Math.sin(k);d.push(new c.a(e,l));return d};c.b.qa=function(a,b){for(var d=a.length,e=[],g,h=0;h<d;h++)0==h?(g=c.a.g(a[0],a[1]),e.push(c.a.f(a[0],a[1],1+b/g)),e.push(c.a.f(a[0],a[1],1-b/g))):d-1==h?(g=c.a.g(a[d-2],a[d-1]),e.push(c.a.f(a[d-2],a[d-1],b/g)),e.push(c.a.f(a[d-2],a[d-1],-b/g))):(e.push(c.a.f(a[h-1],a[h],b/c.a.g(a[h-1],a[h]))),e.push(c.a.f(a[h],
a[h+1],1-b/c.a.g(a[h],a[h+1]))));return e};c.b.I=function(a){if(2>a.length)return a;var d=Math.sqrt(c.c.J(a)/a.length),b=[],k=[];c.c.v(a,b,k,d,d);a=c.b.qa(a,d);d=a[0];d.x=b[0].x;d.y=b[0].y;b=[];for(d=0;d<k.length-1;d++){var g=c.b.m(a[2*d],a[2*d+1],k[d]);b=b.concat(g.reverse())}k=[];k.push(b);return k};c.b.Y=function(a,b){if(2>a.length)return a;b=Math.sqrt(c.c.J(a)/a.length);var d=[];c.c.v(a,[],d,b,b);a=c.b.qa(a,b);b=[];for(var e=0;e<d.length;e++){var g=c.b.m(a[2*e],a[2*e+1],d[e]);g=g.reverse();b.push(g)}return b};
c.b.Qa=function(a){if(2>a.length)return a;var d=[],b=[],k=a[0],g=a[1],h=30/(30+Math.sqrt((k.x-g.x)*(k.x-g.x)+(k.y-g.y)*(k.y-g.y))),l=(g.x-k.x*h)/(1-h),m=(g.y-k.y*h)/(1-h),p=new c.a((k.x-g.x*h)/(1-h),(k.y-g.y*h)/(1-h));h=k.sub(p);h=new c.a(h.y,-h.x);h.normalize(20);p=c.a.f(k,p,.5);k=p.add(h);h=p.sub(h);d.push(k);b.push(h);c.c.v(a,d,b,10,10);l=new c.a(l,m);h=g.sub(l);a=new c.a(h.y,-h.x);a.normalize(20);l=c.a.f(g,l,.5);g=l.sub(a);a=l.add(a);d.push(g);b.push(a);g=[];g.push(d);g.push(b);return g};c.b.f=
function(a,b){var d=new c.K;d.B=6;var e=b.sub(a),g=-1!=d.l?d.l/2:d.B/2,h=new c.a(e.y,-e.x);e=e.clone();e.normalize(e.length()-d.B);e=e.add(a);h=h.clone();h.normalize(g);g=e.add(h);h=e.sub(h);d=c.a.f(b,e,d.F);e=[];e.push(a);e.push(d);e.push(g);e.push(b);e.push(h);e.push(d);return e};c.b.na=function(a,b,f){var d=new c.K;d.B=6;var e=b.sub(a),h=-1!=d.l?d.l/2:d.B/2,l=new c.a(e.y,-e.x);e=e.clone();e.normalize(e.length()-d.B);e=e.add(a);l=l.clone();l.normalize(h);h=e.add(l);l=e.sub(l);d=c.a.f(b,e,d.F);e=
[];e.push(f);e.push(a);e.push(d);e.push(h);e.push(b);e.push(l);e.push(d);return e};c.b.G=function(a,b){var d=[],e=new c.a(0,0);e.x=a.x-b/2;e.y=a.y+.2*b;var g=new c.a(0,0);g.x=a.x-b/2;g.y=e.y-b/3;var h=new c.a(0,0);h.x=a.x-b/2;h.y=e.y+b/3;var l=[];l.push(new c.a(a.x,a.y));l.push(new c.a(a.x+b,a.y));d.push(l);l=[];l.push(g);l.push(h);d.push(l);g=new c.a(0,0);g.x=a.x+b/2;g.y=a.y+.2*b;h=new c.a(0,0);h.x=a.x+b/2;h.y=g.y-b/3;l=new c.a(0,0);l.x=a.x+b/2;l.y=g.y+b/3;var m=[];m.push(h);m.push(l);d.push(m);
h=[];h.push(e);h.push(g);d.push(h);e=new c.a(0,0);e.x=a.x;e.y=g.y;h=new c.a(0,0);h.x=a.x;h.y=g.y-.8*b;a=c.b.f(e,h);d.push(a);return d};c.b.Aa=function(a,b){var d=[],e=[];e.push(new c.a(a.x,a.y));e.push(new c.a(a.x+b,a.y));d.push(e);e=new c.a(0,0);e.x=a.x-b/2;e.y=a.y+.2*b;var g=new c.a(0,0);g.x=a.x-b/2;g.y=e.y-b/3;var h=new c.a(0,0);h.x=a.x-b/2;h.y=e.y+b/3;var l=[];l.push(g);l.push(h);d.push(l);g=new c.a(0,0);g.x=a.x+b/2;g.y=a.y+.2*b;l=new c.a(0,0);l.x=a.x+b/2;l.y=g.y-b/3;h=new c.a(0,0);h.x=a.x+b/
2;h.y=g.y+b/3;var m=[];m.push(l);m.push(h);d.push(m);l=[];m=new c.a(0,0);m.x=e.x;m.y=a.y+Math.sqrt(3)*b/2;var p=new c.a(0,0);p.x=g.x;p.y=a.y+Math.sqrt(3)*b/2;e=new c.a(0,0);e.x=a.x;e.y=h.y;l.push(m);l.push(e);l.push(p);d.push(l);h=new c.a(0,0);h.x=a.x;h.y=g.y-.8*b;a=c.b.f(e,h);d.push(a);return d};c.b.ga=function(a,b){var d=[],e=[];e.push(new c.a(a.x,a.y));e.push(new c.a(a.x+b,a.y));d.push(e);e=new c.a(0,0);e.x=a.x-b/2;e.y=a.y+.2*b;var g=new c.a(0,0);g.x=a.x-b/2;g.y=e.y-b/3;var h=new c.a(0,0);h.x=
a.x-b/2;h.y=e.y+b/3;e=[];e.push(g);e.push(h);d.push(e);e=new c.a(0,0);e.x=a.x+b/2;e.y=a.y+.2*b;var l=new c.a(0,0);l.x=a.x+b/2;l.y=e.y-b/3;var m=new c.a(0,0);m.x=a.x+b/2;m.y=e.y+b/3;var p=[];p.push(l);p.push(m);d.push(p);p=c.a.f(g,h,.66);var n=c.a.f(l,m,.33);l=c.a.f(l,m,.66);m=[];m.push(c.a.f(g,h,.33));m.push(n);d.push(m);g=[];g.push(p);g.push(l);d.push(g);g=new c.a(0,0);g.x=a.x;g.y=l.y;h=new c.a(0,0);h.x=a.x;h.y=e.y-.8*b;a=c.b.f(g,h);d.push(a);return d};c.b.fa=function(a,b,f){b/=c.a.g(a,f);var d=
new c.a(0,0);d.x=(1-b)*a.x+b*f.x;d.y=(1-b)*a.y+b*f.y;return d};c.b.ka=function(a,b){var d=[],e=[];e.push(a);e.push(b);var g=[],h=[],l=b.sub(a);l=new c.a(l.y,-l.x);l.normalize(20);g.push(a.add(l));h.push(a.sub(l));c.c.v(e,g,h,10,10);g.push(b.add(l));h.push(b.sub(l));d.push(g);d.push(h);return d};c.b.la=function(a,b){var d=[],e=[];e.push(a);e.push(b);var g=[],h=[],l=b.sub(a);l=new c.a(l.y,-l.x);l.normalize(20);g.push(a.add(l));h.push(a.sub(l));c.c.v(e,g,h,5,5);g.push(b.add(l));h.push(b.sub(l));a=c.b.ca(g);
h=c.b.ca(h);for(b=0;b<a.length;b++)d.push(a[b]);for(b=0;b<h.length;b++)d.push(h[b]);return d};c.b.ca=function(a){var d=[],b=[];b.push(a[0]);b.push(a[1]);var k=a[1],g=a[2];b.push(c.a.f(k,g,.9));d.push(b);b=[];b.push(c.a.f(k,g,.8));b.push(c.a.f(k,g,.2));d.push(b);b=[];b.push(c.a.f(k,g,.1));b.push(g);b.push(a[3]);d.push(b);return d};c.b.Da=function(a,b){if(5>a.length)return a;var d=a[2],e=c.b.fa(d,b,a[1]),g=c.b.fa(d,b,a[3]);e=c.b.na(a[1],a[0],e);b=c.b.G(d,b);a=c.b.na(a[3],a[4],g);b.push(e);b.push(a);
return b};c.b.Ea=function(a,b){if(2>a.length)return a;var d=a[0],e=a[1],g=new c.a(d.x,e.y);a=c.b.la(d,new c.a(e.x,d.y));g=c.b.la(e,g);b=c.b.G(c.a.f(d,e,.5),b);for(d=0;d<a.length;d++)b.push(a[d]);for(d=0;d<g.length;d++)b.push(g[d]);return b};c.b.Ga=function(a,b){if(5>a.length)return a;var d=c.b.ka(a[0],a[1]),e=c.b.ka(a[2],a[3]);a=c.b.G(a[4],b);for(b=0;b<d.length;b++)a.push(d[b]);for(b=0;b<e.length;b++)a.push(e[b]);return a};c.b.Ha=function(a,b){if(4>a.length)return a;b=c.b.G(a[0],b);var d=c.b.f(a[1],
a[2]);a=c.b.f(a[1],a[3]);b.push(d);b.push(a);return b};c.b.H=function(a,b,f){var d=[];d.push(a);d.push(b);a=[];c.c.v(d,[],a,f,f);return a};c.b.Ia=function(a,b){if(2>a.length)return a;var d=a[0].x,e=a[0].y,g=a[1].x,h=a[1].y;a[0].x>a[1].x&&(d=a[1].x,g=a[0].x);a[0].y>a[1].y&&(e=a[1].y,h=a[0].y);a=new c.a(d,e);g=new c.a(g,h);h=new c.a(g.x,a.y);d=new c.a(a.x,g.y);e=c.b.G(a,b);for(var l=c.b.G(h,b),m=c.b.ga(g,b),p=c.b.ga(d,b),n=[],q=0;q<e.length;q++)n.push(e[q]),n.push(l[q]),n.push(m[q]),n.push(p[q]);for(q=
e.length;q<m.length;q++)n.push(m[q]),n.push(p[q]);n.push(c.b.H(a,d,b));n.push(c.b.H(d,g,b));n.push(c.b.H(g,h,b));n.push(c.b.H(h,a,b));return n};c.b.Ja=function(a,b){if(2>a.length)return a;for(var d=[],e=0;e<a.length;e++){for(var g=c.b.Aa(a[e],b),h=0;h<g.length;h++)d.push(g[h]);e!=a.length-1?(g=a[e],h=a[e+1]):(g=a[e],h=a[0]);d.push(c.b.H(g,h,b))}return d};c.b.Ka=function(a,b){var d=a[0].x,e=a[0].y,g=a[1].x,h=a[1].y;a[0].x>a[1].x&&(d=a[1].x,g=a[0].x);a[0].y>a[1].y&&(e=a[1].y,h=a[0].y);a=new c.a(d,e);
d=new c.a(g,h);g=new c.a(d.x,a.y);h=new c.a(a.x,d.y);e=[];e.push(a);e.push(h);e.push(d);e.push(g);e.push(a);g=c.b.I(e);h=b[0];b=b[1];a=c.a.f(a,d,.5);d=new c.a(a.x-h/4,a.y-b/2);e=new c.a(a.x-h/2,a.y);var l=new c.a(a.x-h/4,a.y+b/2),m=new c.a(a.x,a.y),p=new c.a(a.x+h/4,a.y-b/2),n=new c.a(a.x+h/2,a.y),q=[];q.push(new c.a(a.x+h/4,a.y+b/2));q.push(n);q.push(p);q.push(m);q.push(l);q.push(e);q.push(d);h=c.c.w(q,!1);b=h.pop();a=h.pop();b=c.b.f(a,b);for(a=0;a<b.length;a++)h.push(b[a]);g.push(h);return g};c.b.La=
function(a,b){var d=a[0].x,e=a[0].y,g=a[1].x,h=a[1].y;a[0].x>a[1].x&&(d=a[1].x,g=a[0].x);a[0].y>a[1].y&&(e=a[1].y,h=a[0].y);a=new c.a(d,e);g=new c.a(g,h);h=new c.a(g.x,a.y);var l=new c.a(a.x,g.y),m=[];m.push(a);m.push(l);m.push(g);m.push(h);m.push(a);a=c.b.I(m);g=b[0];b=b[1];d=new c.a(d+30,e+5);e=new c.a(d.x-b/2,d.y+b/2);h=new c.a(d.x,d.y+b);l=new c.a(h.x-b/2,h.y+b/2);m=[];m.push(d);m.push(e);m.push(h);a.push(m);h=c.b.f(h,l);a.push(h);d=new c.a(d.x+5,e.y);e=c.b.f(new c.a(d.x+g,d.y),d);a.push(e);e=
new c.a(d.x+g/2+10,d.y-b/2);h=new c.a(d.x+g/2+10,d.y+b/2);l=[];l.push(e);l.push(h);a.push(l);g=c.b.m(new c.a(d.x+g/4,e.y),new c.a(d.x+g/4,h.y),new c.a(d.x+g/4+b/2,(h.y+e.y)/2));a.push(g);return a};c.b.Ma=function(a,b){var d=a[0].x,e=a[0].y,g=a[1].x,h=a[1].y;a[0].x>a[1].x&&(d=a[1].x,g=a[0].x);a[0].y>a[1].y&&(e=a[1].y,h=a[0].y);a=new c.a(d,e);d=new c.a(g,h);g=new c.a(d.x,a.y);h=new c.a(a.x,d.y);e=[];e.push(a);e.push(h);e.push(d);e.push(g);e.push(a);g=c.b.I(e);h=b[0];b=b[1];a=c.a.f(a,d,.5);d=c.b.f(new c.a(a.x,
a.y-b/2),new c.a(a.x-h-10,a.y-b/2));g.push(d);d=new c.a(a.x-h/2,a.y);e=[];e.push(new c.a(a.x-h/2,a.y-b));e.push(d);g.push(e);b=c.b.m(new c.a(a.x-3*h/4-b/2,a.y-b),new c.a(a.x-3*h/4-b/2,a.y),new c.a(a.x-3*h/4,a.y-b/2));g.push(b);return g};c.b.ia=function(a){a=c.b.m(a[0],a[2],a[1]);a.pop();a.pop();var b=a.pop(),d=a.pop();b=c.b.f(d,b);for(d=0;d<b.length;d++)a.push(b[d]);return a};c.b.Na=function(a,b){var d=a[0];2==a.length&&(d=c.a.f(a[0],a[1],.5));a=b[0];b=b[1];var e=new c.a(d.x-a/2,d.y),g=new c.a(d.x+
a/2,d.y),h=new c.a(d.x,d.y-b/2),l=new c.a(d.x,d.y+b/2);b=[];var m=[];m.push(e);m.push(h);m.push(g);h=c.b.ia(m);b.push(h);m[0]=g;m[1]=l;m[2]=e;h=c.b.ia(m);b.push(h);e=new c.a(e.x-10,d.y);e=c.b.f(new c.a(e.x-a,d.y),e);b.push(e);g=new c.a(g.x+10,d.y);d=c.b.f(new c.a(g.x+a,d.y),g);b.push(d);return b};c.b.Oa=function(a){return c.b.da(a[0],c.a.g(a[0],a[1]),0,2*Math.PI)};c.b.Pa=function(b){var d=[];d.push(b[0]);var f=c.a.g(b[0],b[1]),k=a(b[1],b[0]),g=a(b[2],b[0]);g<k&&(g+=2*Math.PI);b=c.b.da(b[0],f,k,g);
return d.concat(b)};c.b.Ra=function(a,b,f){var d=null,e=new c.K;if(2001==a){if(4>b.length)return;d=c.b.ja(b[0],b[1],b[3],b[2],e)}else if(2003==a)d=c.b.L(b[0],b[1],e,.125,.5);else if(2004==a)e.l=.8*c.a.g(b[0],b[1]),e.F=0,d=c.b.L(b[0],b[1],e,.35,.8);else if(2005==a)d=c.b.N(b[0],b[1],b[2],e,!1);else if(2006==a)d=c.b.N(b[0],b[1],b[2],e,!0);else if(2007==a)d=c.b.ha(b,e);else if(2008==a)d=c.b.w(b,!0);else if(2011==a)d=c.b.ma(b[0],b[1],b[2]);else{if(2031==a)return d=c.b.m(b[0],b[1],b[2]),[d];if(2032==a)d=
c.b.I(b);else if(2033==a)d=c.b.Y(b,f);else if(2034==a)d=c.b.Qa(b);else if(2035==a)d=c.b.Da(b,f[0]);else if(2036==a)d=c.b.Ea(b,f[0]);else if(2037==a)d=c.b.Ga(b,f[0]);else if(2038==a)d=c.b.Ha(b,f[0]);else if(2039==a)d=c.b.Ia(b,f[0]);else if(2040==a)d=c.b.Ja(b,f[0]);else if(2041==a)d=c.b.Ka(b,f);else if(2042==a)d=c.b.La(b,f);else if(2043==a)d=c.b.Ma(b,f);else if(2044==a)d=c.b.Na(b,f);else if(2052==a)d=c.b.I(b);else if(2053==a)d=c.b.Y(b,f);else if(2054==a)d=c.b.Y(b,f);else{if(2055==a||2056==a||2057==
a)return d=c.b.m(b[0],b[1],b[2]),[d];if(2060==a)return d=c.b.Oa(b),[d];if(2061==a)return d=c.b.Pa(b),[d]}}return d};window.H5JB_getJBArray=function(a,b,f){for(var d=[],e=0;e<b.length;e+=2)d.push(new c.a(b[e],b[e+1]));return c.b.Ra(a,d,f)}})();function pointDistance(a,b){var c=b.x-a.x;a=b.y-a.y;return Math.sqrt(c*c+a*a)}var R=6371E3;function distanceBetween(a,b){var c=Math.PI/180,d=Math.sin((b.lat-a.lat)*c/2),e=Math.sin((b.lng-a.lng)*c/2);a=d*d+Math.cos(a.lat*c)*Math.cos(b.lat*c)*e*e;return 2*R*Math.atan2(Math.sqrt(a),Math.sqrt(1-a))}function computeSegmentHeading(a,b){return(180*Math.atan2(b.y-a.y,b.x-a.x)/Math.PI+450)%360}function asRatioToPathLength(a,b){var c=a.value;return a.isInPixels?c/b:c}
...
for(var a=0;a<this._lineLayers.length;a++)this._lineLayers[a].off("click",this._symbolClick,this);this._draw()}},_symbolClick:function(a){alert("clicked:"+this._keyid);this._map.drawHelper.showEditPage(1,this._keyid,this)},_getFillPattern:function(a){var b=a.fillType,c=new GMap.StripePattern({spaceOpacity:1,angle:60});if("fillByHline"==b)c=new GMap.StripePattern({spaceOpacity:1,angle:0,color:a.stroke});else if("fillByVline"==b)c=new GMap.StripePattern({spaceOpacity:1,angle:90,color:a.stroke});else if("fillByXieline"==
b)c=new GMap.StripePattern({spaceOpacity:1,angle:60,color:a.stroke});else if("fillByAntixieline"==b)c=new GMap.StripePattern({spaceOpacity:1,angle:120,color:a.stroke});else if("fillByJinline"==b)return b=new GMap.PatternPath({d:"M0 4 L8 4  Z",fill:!0,weight:1,color:a.stroke}),a=new GMap.PatternPath({d:"M4 0 L4 8 Z",fill:!0,weight:1,color:a.stroke}),c=new GMap.Pattern({width:8,height:8}),c.addShape(b),c.addShape(a),c.addTo(this._map),c;c.addTo(this._map);return c},_getPatternLayers:function(){var a=
this;this._map.getBounds().pad(.1);var b={color:a._style.stroke,weight:a._style.strokeWidth,opacity:a._style.outlineOpacity};return this._paths.map(function(c){c=a._getPolyFromPos(a._keyid,c);for(var d=[],e=0;e<c.length;e++)if(2031==a._keyid||2055==a._keyid||2056==a._keyid||2057==a._keyid)if(null==a._style._patterns)d.push(GMap.polyline(c[e],b));else{var f=GMap.polylineSymbol(c[e],{patterns:a._style._patterns});d.push(f)}else if(2032==a._keyid||2034==a._keyid||2052==a._keyid)d.push(GMap.polyline(c[e],
...
a._style),d.push(f);return GMap.featureGroup(d)})},_createPolygonWithPattern:function(a,b){this._getFillPattern(b);var c=this._getFillPattern(b);return"fillByNone"==b.fillType?GMap.polygon(a,{fill:!1,color:b.stroke,weight:b.strokeWidth,opacity:b.outlineOpacity}):"fillByColor"==b.fillType?GMap.polygon(a,{fill:!0,color:b.stroke,weight:b.strokeWidth,opacity:b.outlineOpacity}):GMap.polygon(a,{color:b.stroke,weight:b.strokeWidth,fillPattern:c,fillOpacity:b.outlineOpacity})},_getPolyFromPos:function(a,
b){var c=[],d=b.length,e;var f=[];for(e=0;e<d;e++)f[e]=this._map.latLngToLayerPoint(b[e]);d=!1;e=[];var k=[25];if(2031==a||2055==a||2056==a||2057==a||2061==a){if(3<=f.length){for(d=0;3>d;d++)e.push(f[d].x),e.push(f[d].y);d=!0}}else if(2032==a||2033==a||2052==a||2053==a||2054==a){if(3<=f.length){for(d=0;d<f.length;d++)e.push(f[d].x),e.push(f[d].y);d=!0}}else if(2034==a||2060==a){if(2<=f.length){for(d=0;2>d;d++)e.push(f[d].x),e.push(f[d].y);d=!0}}else if(2035==a||2036==a||2037==a||2038==a||2039==a||
2040==a||2041==a||2042==a||2043==a||2044==a){for(d=0;d<f.length;d++)e.push(f[d].x),e.push(f[d].y);d=!0}if(1==d){if(2041==a||2042==a||2043==a||2044==a)d=this._map.getZoom(),d=this._sizeArray[d],k[0]=d[0],k[1]=d[1];b=H5JB_getJBArray(a,e,k);f=[];if(2030>a){for(d=0;d<b.length;d++)a=this._map.layerPointToLatLng(b[d]),c.push(a);f.push(c)}else for(d=0;d<b.length;d++){c=[];e=b[d];for(k=0;k<e.length;k++)a=this._map.layerPointToLatLng(e[k]),c.push(a);f.push(c)}return f}return b},_draw:function(){this._lineLayers=
this._getPatternLayers();for(var a=0;a<this._lineLayers.length;a++)this._lineLayers[a].on("click",this._symbolClick,this);this.addLayer(GMap.featureGroup(this._lineLayers))},_setStyle:function(a){this._style.fillType=a.fillType;this._style.stroke=a.outlineColor;this._style.strokeWidth=a.outlineWidth;this._style.outlineOpacity=a.opacity;this._style._patterns="dash"==a.lineType?g_patterns[0]:"point"==a.lineType?g_patterns[1]:"ptline"==a.lineType?g_patterns[2]:null;if(null!=this._style._patterns){a=
this._style._patterns;for(var b=0;b<a.length;b++)a[b].symbol.options.pathOptions.color=this._style.stroke,a[b].symbol.options.pathOptions.weight=this._style.strokeWidth}this.redraw()}});GMap.polylineJBSymbol=function(a,b){return new GMap.PolylineJBSymbol(a,b)};
...
GMap.PlotUtils.getCircleCenterOfThreePoints=function(a,b,c){var d=[(a[0]+b[0])/2,(a[1]+b[1])/2],e=[(a[0]+c[0])/2,(a[1]+c[1])/2];return GMap.PlotUtils.getIntersectPoint(d,[d[0]-a[1]+b[1],d[1]+a[0]-b[0]],e,[e[0]-a[1]+c[1],e[1]+a[0]-c[0]])};
...
d=this._marker.options.icon.options.style;a=[a.lat,a.lng];if(141!=b){var e=c.drawSymbol(b,d);c=c.geticonAnchorFromStyle(d,b);b=GMap.canvasIcon({canvas:e,iconSize:[d.symbolWidth,d.symbolHeight],iconAnchor:c,keyid:b,style:d,name:this._marker.options.icon.options.name,className:"myMarker"})}else b=new GMap.GDivLineIcon({html:'<font size="'+d.font_size+'" color="'+d.textcolor+'">'+d.label+"</font>",className:"my-div-icon",iconSize:[d.symbolWidth,d.symbolHeight],keyid:b,style:d,name:this._marker.options.icon.options.name});
b=GMap.marker(a,{icon:b,name:this._marker.options.icon.options.name});GMap.Draw.Feature.prototype._fireCreatedEvent.call(this,b)}});
...
GMap.GLineLabelOverlay=GMap.DivOverlay.extend({options:{pane:"tooltipPane",offset:[0,0],direction:"auto",permanent:!1,sticky:!1,interactive:!1,opacity:.9},onAdd:function(a){GMap.DivOverlay.prototype.onAdd.call(this,a);this.setOpacity(this.options.opacity);this._map=a},onRemove:function(a){GMap.DivOverlay.prototype.onRemove.call(this,a);null!=this._poly&&(this._map.removeLayer(this._poly),delete this._poly);null!=this._wrapper&&this.getPane().removeChild(this._wrapper)},getEvents:function(){return GMap.DivOverlay.prototype.getEvents.call(this)},
_close:function(){this._map&&this._map.closeLineLabel(this)},_initLayout:function(){this._contentNode=this._container=GMap.DomUtil.create("div","label-overlay");null==this._poly&&this.options.showLineLabel&&(this._poly=new GMap.Polyline([],this.options.shapeOptions),this._map.addLayer(this._poly));var a=document.createElement("span");a.className="mapjb-marker-iconlabel "+this.options.labelClassName;a.innerHTML=this.options.annoText;this._container.appendChild(a);a=document.createElement("span");a.className=
"mapjb-marker-iconlabel "+this.options.labelClassName;a.innerHTML=this.options.annoDetailText;this._container.appendChild(a);a=document.createElement("div");a.className="mapjb-marker-icon-wrapper mapjb-zoom-animated";this._wrapper=a;this._wrapper.innerHTML=this.options.label;this.getPane().appendChild(this._wrapper)},_updateLayout:function(){},_adjustPan:function(){},_updateContent:function(){},_setPosition:function(a){var b=this._map,c=b.latLngToContainerPoint(b.getCenter()),d=b.layerPointToContainerPoint(a),
e=this.options.direction,f=GLineLabelOverlay_toPoint(this.options.offset),k=this._getAnchor(),g=this._wrapper.offsetWidth,h=this._wrapper.offsetHeight;b=new GMap.Point(a.x,a.y);b="top"===e?b.add(GLineLabelOverlay_toPoint(-g/2+f.x,-h+f.y+k.y,!0)):"bottom"===e?b.subtract(GLineLabelOverlay_toPoint(g/2-f.x,-f.y,!0)):"center"===e?b.subtract(GLineLabelOverlay_toPoint(g/2+f.x,h/2-k.y+f.y,!0)):"right"===e||"auto"===e&&d.x<c.x?b.add(GLineLabelOverlay_toPoint(f.x+k.x,k.y-h/2+f.y,!0)):b.subtract(GLineLabelOverlay_toPoint(g+
k.x-f.x,h/2-k.y-f.y,!0));new GMap.Point(a.x,a.y);d=this._container.childNodes[0].offsetHeight;c=this._container.childNodes[0].offsetWidth;d=null===this.options.offset?new GMap.Point(a.x,a.y):new GMap.Point(a.x+this.options.lineOffset.x,a.y-this.options.lineOffset.y-d);GMap.DomUtil.setPosition(this._container,d);GMap.DomUtil.setPosition(this._wrapper,b);this.options.showLineLabel&&(null==this._poly&&(this._poly=new GMap.Polyline([],this.options.shapeOptions),this._map.addLayer(this._poly)),b=new GMap.Point(a.x+
this.options.lineOffset.x+c,a.y-this.options.lineOffset.y),b=this._map.layerPointToLatLng(b),a=new GMap.Point(a.x+this.options.lineOffset.x/2,a.y-this.options.lineOffset.y),this._map.layerPointToLatLng(a),a=this._map.layerPointToLatLng(a),c=[],c.push(this._latlng),c.push(a),c.push(b),this._poly.setLatLngs(c));0==this.options.showLineLabel&&null!=this._poly&&this._map.hasLayer(this._poly)&&this._map.removeLayer(this._poly);1==this.options.showLineLabel?(this._container.childNodes[0].style.visibility=
"",this._container.childNodes[1].style.visibility=1==this.options.showDetailLabel?"":"hidden"):(this._container.childNodes[0].style.visibility="hidden",this._container.childNodes[1].style.visibility="hidden")},_updatePosition:function(){var a=this._map.latLngToLayerPoint(this._latlng);this._setPosition(a)},setOpacity:function(a){this.options.opacity=a;this._container&&GMap.DomUtil.setOpacity(this._container,a)},_animateZoom:function(a){a=this._map._latLngToNewLayerPoint(this._latlng,a.zoom,a.center);
this._setPosition(a)},_getAnchor:function(){return GLineLabelOverlay_toPoint(this._source&&this._source._getTooltipAnchor&&!this.options.sticky?this._source._getTooltipAnchor():[0,0])}});GMap.Map.include({openLineLabel:function(a,b,c){a instanceof GMap.GLineLabelOverlay||(a=(new GMap.GLineLabelOverlay(c)).setContent(a));b&&a.setLatLng(b);return this.hasLayer(a)?this:this.addLayer(a)},closeLineLabel:function(a){a&&this.removeLayer(a);return this}});
...
GMap.GGTextLineOverly=GMap.DivOverlay.extend({options:{pane:"tooltipPane",offset:[0,0],direction:"auto",permanent:!1,sticky:!1,interactive:!1,opacity:.9},onAdd:function(a){GMap.DivOverlay.prototype.onAdd.call(this,a);this.setOpacity(this.options.opacity);this._map=a},onRemove:function(a){GMap.DivOverlay.prototype.onRemove.call(this,a);null!=this._poly&&(this._map.removeLayer(this._poly),delete this._poly)},getEvents:function(){return GMap.DivOverlay.prototype.getEvents.call(this)},_close:function(){this._map&&
this._map.closeTextLine(this)},_initLayout:function(){this._contentNode=this._container=GMap.DomUtil.create("div","label-overlay");null==this._poly&&(this._poly=new GMap.Polyline([],this.options.shapeOptions),this._map.addLayer(this._poly))},_updateLayout:function(){},_adjustPan:function(){},_updateContent:function(){},_setPosition:function(a){var b=this._map;b.latLngToContainerPoint(b.getCenter());b.layerPointToContainerPoint(a);var c=this.options.direction;GGTextLineOverly_toPoint(this.options.offset);
this._getAnchor();null==this._poly&&(this._poly=new GMap.Polyline([],this.options.shapeOptions),this._map.addLayer(this._poly));b=this._source._icon;if(null!=b){var d=b.offsetWidth,e=this._source.options.icon.options.iconSize,f=a.x-e[0]/2;b=a.y+b.offsetHeight-e[1]/2;"bottom"==c&&(b=a.y-e[1]/2);c=f+d;a=new GMap.Point(f,b);a=this._map.layerPointToLatLng(a);b=new GMap.Point(c,b);b=this._map.layerPointToLatLng(b);f=[];f.push(b);f.push(a);this._poly.setLatLngs(f)}},_updatePosition:function(){var a=this._map.latLngToLayerPoint(this._latlng);
this._setPosition(a)},setOpacity:function(a){this.options.opacity=a;this._container&&GMap.DomUtil.setOpacity(this._container,a)},_animateZoom:function(a){a=this._map._latLngToNewLayerPoint(this._latlng,a.zoom,a.center);this._setPosition(a)},_getAnchor:function(){return GGTextLineOverly_toPoint(this._source&&this._source._getTooltipAnchor&&!this.options.sticky?this._source._getTooltipAnchor():[0,0])}});
GMap.Map.include({openTextLine:function(a,b,c){a instanceof GMap.GGTextLineOverly||(a=(new GMap.GGTextLineOverly(c)).setContent(a));b&&a.setLatLng(b);return this.hasLayer(a)?this:this.addLayer(a)},closeTextLine:function(a){a&&this.removeLayer(a);return this}});
...
GMap.GWenziLine=GMap.Polyline.extend({_editIcon:GMap.divIcon({className:"gmap-div-icon gmap-editing-icon"}),options:{weight:2,color:"#000",readOnly:!1},initialize:function(a,b){this._controlLatLngs=[];this._lineMarkers=[];this._setControlLatLngs(a);GMap.Polyline.prototype.initialize.call(this,[],b)},onAdd:function(a){GMap.Polyline.prototype.onAdd.call(this,a);this._map=a;this._plotExisting();this.options.readOnly||this._bindMapClick()},onRemove:function(){for(index in this._lineMarkers)this._map.removeLayer(this._lineMarkers[index]);
this._lineMarkers=[];this._unbindMapClick();GMap.Polyline.prototype.onRemove.call(this,map)},setTextContainer:function(a){this.textobj=a},setLatLngs:function(a){GMap.Polyline.prototype.setLatLngs.call(this,a)},setReadOnly:function(a){if(a&&!this.options.readOnly){var b="_unbindMarkerEvents";this._unbindMapClick()}else!a&&this.options.readOnly&&(b="_bindMarkerEvents",this._bindMapClick());if("undefined"!==typeof b)for(index in this.options.readOnly=a,this._lineMarkers)this[b](this._lineMarkers[index])},
_bindMapClick:function(){this._map.on("click",this._onMapClick,this)},_unbindMapClick:function(){this._map.off("click",this._onMapClick,this)},_setControlLatLngs:function(a){this._controlLatLngs=a},_replot:function(a){if(a){a=a.target.options.index;var b=-1;1==a?b=2:2==a&&(b=1);if(0<b){b=this._lineMarkers[b];var c=b.getLatLng().lng;a=this._lineMarkers[a].getLatLng().lat;b.setLatLng(new GMap.LatLng(a,c));a=this._map.latLngToLayerPoint(this._lineMarkers[0].getLatLng());b=this._map.latLngToLayerPoint(this._lineMarkers[1].getLatLng());
this.textobj.options.offset.y=a.y-b.y;this.textobj.options.offset.x=b.x-a.x}this.textobj._latlng.lat=this._lineMarkers[0].getLatLng().lat;this.textobj._latlng.lng=this._lineMarkers[0].getLatLng().lng;this.textobj._reset()}this._redraw()},_getNewMarker:function(a,b){return new GMap.marker(a,b)},_unbindMarkerEvents:function(a){a.off("drag",this._replot,this);a.dragging.disable()},_bindMarkerEvents:function(a){a.on("drag",this._replot,this);a.dragging.enable()},_addToMapAndBindMarker:function(a){a.addTo(this._map);
this.options.readOnly||this._bindMarkerEvents(a)},_removePoint:function(a){this._map.removeLayer(this._lineMarkers[this._lineMarkers.indexOf(a.target)]);this._lineMarkers.splice(this._lineMarkers.indexOf(a.target),1);this._replot()},_onMapClick:function(a){},_addNewMarker:function(a){a=this._getNewMarker(a.latlng,{icon:this._editIcon,index:a.index});this._addToMapAndBindMarker(a);this._lineMarkers.push(a)},setEdit:function(a){var b="block";0==a&&(b="none");for(a=0;a<this._lineMarkers.length;a++)this._lineMarkers[a]._icon.style.display=
b},_plotExisting:function(){for(var a=0;a<this._controlLatLngs.length;a++){var b=this._lineMarkers[a];null==b?this._addNewMarker({latlng:this._controlLatLngs[a],index:a}):b.setLatLng(this._controlLatLngs[a])}this._replot()},_redraw:function(){this.setLatLngs([]);this.redraw();for(var a=[],b=0;b<this._lineMarkers.length;b++)a.push(this._lineMarkers[b].getLatLng());this.setLatLngs(a);this.redraw()}});(function(a,b,c){GMap.Pattern=GMap.Class.extend({includes:[GMap.Evented],options:{x:0,y:0,width:8,height:8,patternUnits:"userSpaceOnUse",patternContentUnits:"userSpaceOnUse"},_addShapes:GMap.Util.falseFn,_update:GMap.Util.falseFn,initialize:function(a){this._shapes={};GMap.setOptions(this,a)},onAdd:function(a){this._map=a.target?a.target:a;this._map._initDefRoot();this._initDom();for(var b in this._shapes)this._shapes[b].onAdd(this);this._addShapes();this._addDom();this.redraw();if(this.getEvents)this._map.on(this.getEvents(),
...
this._dom.setAttribute("points",this.options.points)}})})(window,document);
