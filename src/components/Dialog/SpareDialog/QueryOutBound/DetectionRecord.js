...
export default class DetectionRecord extends Component {
    constructor(props) {
        super();
        this.state = {
    ...
    render() {
        const columns = [
            ...
            {
                title: '检测日期',
                dataIndex: 'detectionData', key: 'detectionData',
                width: '25%',
            },
            {
                title: '检修单位',
                width: '25%',
                dataIndex: 'detectionUnit', key: 'detectionUnit',
            }, {
                title: '检修人',
                width: '20%',
                dataIndex: 'detectionMan', key: 'detectionMan',
            }, {
                title: '检修结果',
                width: '20%',
                dataIndex: 'detectionResults', key: 'detectionResults',
            }
        ];
