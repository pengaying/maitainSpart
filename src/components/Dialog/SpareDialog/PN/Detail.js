        ...
        if (props.pnDetailData != null && props.pnDetailData !== undefined) {
            return {
                brand: Form.createFormField({
                    ...props,
                    value: props.pnDetailData.brand,
                }),
                category: Form.createFormField({
                    ...props,
                    value: props.pnDetailData.category,
                }),
                level: Form.createFormField({
                    ...props,
                    value: props.pnDetailData.level,
                }),
                model: Form.createFormField({
                    ...props,
                    value: props.pnDetailData.model,
                }),
                name: Form.createFormField({
                    ...props,
                    value: props.pnDetailData.name,
                }),
                pn: Form.createFormField({
                    ...props,
                    value: props.pnDetailData.pn,
                }),
                remarks: Form.createFormField({
                    ...props,
                    value: props.pnDetailData.remarks,
                }),
                threshold: Form.createFormField({
                    ...props,
                    value: props.pnDetailData.threshold,
                }),
            };
        }
    }
